...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("MW:Remastered Countdown");
        ...
        tabLayout.getTabAt(0).setIcon(R.drawable.ic_timelapse_white_24dp);
        tabLayout.getTabAt(1).setIcon(R.drawable.ic_view_headline_white_24dp);
